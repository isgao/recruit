...
<script src="<?=Yii::$app->request->baseUrl;?>/assets/js/jquery.easy-pie-chart.min.js"></script>
<script src="<?=Yii::$app->request->baseUrl;?>/assets/js/jquery.sparkline.min.js"></script>
